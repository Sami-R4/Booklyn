...
<head>
  ...
  <style>
    ...
    .bg-light-gold {
      background-color: rgba(241, 83, 9, 0.15);
    }
  </style>
</head>
<body>
...
?>
  ...
  <div class="form-check form-switch mb-3">
    ...
    <label class="form-check-label" for="emailUpdates">Dark Mode</label>
  </div>
  <div class="form-check form-switch mb-3">
    <input class="form-check-input" type="checkbox" id="emailVisible">
    <label class="form-check-label" for="emailVisible">Show Email to Other Users</label>
  </div>
  <div class="form-check form-switch mb-3">
    <input class="form-check-input" type="checkbox" id="shareActivity">
    <label class="form-check-label" for="shareActivity">Share My Activity</label>
  </div>
</div>
      ...
      <div class="tab-pane fade" id="delete" role="tabpanel">
        ...
        <div class="bg-light-gold border border-warning text-dark mt-3">
