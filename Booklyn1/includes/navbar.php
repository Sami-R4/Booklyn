...
<nav class="py-2">
    ...
    <ul class="mt-3">
        ...
        <li><a href="../pages/library.php" class="<?php echo $currentPage == 'library.php'? 'active': ''?>">Libraries</a></li>
    </ul>
  ...
  <div class="modal-dialog modal-dialog-bottom">
    ...
    <span class="gold-glow">Welcome Back</span>
      ...
      <div class="modal-body">
        <form action="../app/processlog.php" method="post" class="w-50 sm-w-100">
          <div class="mb-3">
          ...
          <button type="submit" name="login" class="btn btn-gold w-50 text-white d-block mx-auto py-2 mb-3">Sign In</button>
